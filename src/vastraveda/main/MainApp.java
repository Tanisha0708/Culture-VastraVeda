...
public class MainApp extends JFrame {
    ...
    private static final String[][] FEATURE_META = {
        ...
        { "8",  "💬",  "Debate Board",          "Threads, replies, moderator close",  "#00695C" },
        { "9",  "🛡",  "Issue Tracker",         "Cultural accuracy — report & resolve", "#AD1457" },
        { "10", "🏆",  "Contributor Leaderboard", "Rank contributors — filters & scores", "#37474F" },
        { "11", "📥",  "Dataset Export",        "JSON / CSV download + metadata",    "#558B2F" },
